...
import { Upload, FolderPlus, FileText, ArrowRight } from 'lucide-react';
    ...
    <RecentUploadsProvider>
      <div className="p-6 space-y-6 max-w-7xl mx-auto">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Welcome back — here's an overview of your storage.</p>
        </div>
          ...
          <div className="md:col-span-2 rounded-xl border border-border bg-card p-5">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              >
                ...
                <span className="text-xs font-medium text-foreground">New Folder</span>
              </Link>
              <Link
                to="/dashboard"
                className="flex flex-col items-center gap-2 p-4 rounded-lg border border-border hover:border-primary/40 hover:bg-primary/5 transition-colors text-center"
              >
                ...
                <span className="text-xs font-medium text-foreground">New Document</span>
              </Link>
            </div>
          </div>
        </div>
