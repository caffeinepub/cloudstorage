...
export class Backend implements backendInterface {
    ...
    async getRegisteredUsersWithQuota(): Promise<Array<[Principal, bigint, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRegisteredUsersWithQuota();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setUserQuotaInBytes(arg0: Principal, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setUserQuotaInBytes(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
